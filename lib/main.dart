  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(children: [
        Align(alignment: Alignment.topCenter,child: Container(color: Colors.white,width: double.infinity,height: height*0.06,child: Column(
          children: [
            Container(width: double.infinity,height: ( height*0.06)-1,
              child: Stack(children: [
                Align(alignment: Alignment.centerLeft,child: IconButton(onPressed: (){

                },icon:Icon( Icons.camera_alt_outlined),),),
                Align(alignment: Alignment.center,child: Text("We Tour",style: TextStyle(fontSize: height*0.018),),),
       ...
       Expanded(child: ListView(shrinkWrap: true,
         children: [
           Wrap(
             children: [
               ...
               Container(width: double.infinity,height: height*0.5,child: Container(color: Colors.grey,),)
             ],
           ),
           Wrap(
             children: [
        ...
        Align(alignment: Alignment.bottomCenter,child: Container(color: Colors.white,width: double.infinity,height: height*0.06,child: Column(
          children: [
            Container(width: double.infinity,height: 1,color: Colors.grey,),
            Container(width: double.infinity,height:  ( height*0.06)-1,
              child: Row(children: [
